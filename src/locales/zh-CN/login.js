export default {
  ...
  'app.register-result.msg': '恭喜您的账户：{email} 注册成功',
  'admin.register-result.msg': '恭喜您的账户：{email} 注册成功',
  'admin.register-result': '恭喜您的账户：{email} 注册成功',
  ...
  'validation.confirm-password.required': '请输入密码！',
