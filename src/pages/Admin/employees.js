...
@connect(({ yuangong, loading }) => ({
  yuangong,
  loading: loading.effects['yuangong/fetch'],
}))
@Form.create()
class Register extends Component {
  ...
  componentDidMount() {
    ...
    setTimeout(() => {
      const { yuangong } = this.props;
      console.log(8888,yuangong)
      this.setState({
        data:yuangong.datas.result,
        data2:[yuangong.datas.result[yuangong.datas.result.length-1]]
      })
    },1000)
  ...
  componentDidUpdate() {
    const { yuangong } = this.props;
    if(yuangong.datas.code!==0){
      message.error(yuangong.datas.msg)
    }
          ...
          <Row className={styles.contenner}>
            ...
            >
              ...
              >
                ...
                <div>
                  {this.state.loading ? <Spin tip="正在加载"  className={styles.centerjiazai} /> : <ORG orgdata={this.state.datas} orgdata2={this.state.data2}></ORG> }
              ...
              >
                <h3>汇报线</h3>
                <div>
                  {this.state.loading ? <Spin tip="正在加载"  className={styles.centerjiazai} /> : <ORG2 orgdata2={this.state.data2}></ORG2> }
                </div>
